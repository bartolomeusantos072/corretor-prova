...
const criarLinhaQuestao = (numero, dados = null) => {
    ...
    div.innerHTML = `
        ...
        <button type="button" class="btn-remover-linha text-red-400 hover:text-red-600 ml-2 opacity-0 group-hover:opacity-100 transition-all" title="Remover esta questão">
